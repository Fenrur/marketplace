...
public class ShoppingCart {
    ...
    public void add(UUID productId, double price, int amount) {
        cart.addOccurrences(new Key(productId, price), amount);
    }

    public void remove(UUID productId, double price, int amount) {
    ...
    private record Key(UUID productId, double price) {
